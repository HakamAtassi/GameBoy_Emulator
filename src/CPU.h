...
namespace GameBoy{
	class CPU{
		...
		private:
			...
			/*0xC0*/
			int ret_nz();			int pop_bc();			int jp_nz_a16();	int jp_a16();		int call_nz_a16();	int push_bc();		int add_a_d8();		int rst_a0();
			int ret_z();			int ret();				int jp_z_a16();		int call_z_a16();	int call_z16();		int adc_a_d8();		int rst_1();
			...
			int ld_a16_a();			int xor_d8();			int rst_5();
			...
			/*0x00*/
			int rlc_b();	int rlc_c();	int rlc_d();	int rlc_e();	int rlc_h();	int rlc_l();	int rlc_hl();	int rlc_a();
			int rrc_b();	int rrc_c();	int rrc_d();	int rrc_e();	int rrc_h();	int rrc_l();	int rrc_hl();	int rrc_a();

			/*0x01*/
			int rl_b();		int rl_c();		int rl_d();		int rl_e();		int rl_h();		int rl_l();		int rl_hl();	int rl_a();
			int rr_b();		int rr_c();		int rr_d();		int rr_e();		int rr_h();		int rr_l();		int rr_hl();	int rr_a();
		
			/*0x02*/
			int sla_b();	int sla_c();	int sla_d();	int sla_e();	int sla_h();	int sla_l();	int sla_hl();	int sla_a();
			int sra_b();	int sra_c();	int sra_d();	int sra_e();	int sra_h();	int sra_l();	int sra_hl();	int sra_a();

			/*0x03*/
			int swap_b();	int swap_c();	int swap_d();	int swap_e();	int swap_h();	int swap_l();	int swap_hl();	int swap_a();
			int srl_b();	int srl_c();	int srl_d();	int srl_e();	int srl_h();	int srl_l();	int srl_hl();	int srl_a();

			/*0x04*/
			int bit_0_b();	int bit_0_c();	int bit_0_f();	int bit_0_e();	int bit_0_h();	int bit_0_l();	int bit_0_hl();	int bit_0_a();
			int bit_1_b();	int bit_1_c();	int bit_1_f();	int bit_1_e();	int bit_1_h();	int bit_1_l();	int bit_1_hl();	int bit_1_a();

			/*0x05*/
			int bit_2_b();	int bit_2_c();	int bit_2_f();	int bit_2_e();	int bit_2_h();	int bit_2_l();	int bit_2_hl();	int bit_2_a();
			int bit_3_b();	int bit_3_c();	int bit_3_f();	int bit_3_e();	int bit_3_h();	int bit_3_l();	int bit_3_hl();	int bit_3_a();
			...
			int res_1_b();	int res_1_c();	int res_1_f();	int res_1_e();	int res_1_h();	int res_1_l();	int res_1_hl();	int res_1_a();

			/*0x09*/
			int res_2_b();	int res_2_c();	int res_2_f();	int res_2_e();	int res_2_h();	int res_2_l();	int res_2_hl();	int res_2_a();
			int res_3_b();	int res_3_c();	int res_3_f();	int res_3_e();	int res_3_h();	int res_3_l();	int res_3_hl();	int res_3_a();
			...
			int set_1_b();	int set_1_c();	int set_1_f();	int set_1_e();	int set_1_h();	int set_1_l();	int set_1_hl();	int set_1_a();

			/*0x0D*/
			int set_2_b();	int set_2_c();	int set_2_f();	int set_2_e();	int set_2_h();	int set_2_l();	int set_2_hl();	int set_2_a();
			int set_3_b();	int set_3_c();	int set_3_f();	int set_3_e();	int set_3_h();	int set_3_l();	int set_3_hl();	int set_3_a();
